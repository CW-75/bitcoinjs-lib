...
export class Transaction {
  ...
  /** This hashTypes are compatibles with bch */
  static readonly SIGHASH_ALL_FORK_ID = 0x41;
  static readonly SIGHASH_NONE_FORK_ID = 0x42;
  static readonly SIGHASH_SINGLE_FORK_ID = 0x43;
  ...
  hashForSignatureV2(inIndex, prevOutScript, inAmount, hashType) {
    // typeforce(types.tuple(types.UInt32, types.Buffer, /* types.UInt8 */ types.Number, types.UInt32, arguments))
    ...
    if (hashType & Transaction.SIGHASH_FORK_ID) {
